...
| **Клеточный реверс** | `rev <binary> <dir>`, `rev report/decomp --struct/...` | .eml-граф, **сводный отчёт (vftables/строки/топ-вызовы/декомп)**, структурный декомпилятор, волны, ветки |
