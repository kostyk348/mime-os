...
| **Клеточный реверс** | `rev <binary> <dir>`, `rev report/stats/decomp-all/decomp --struct/field/...` | .eml-граф, **массовая декомпиляция всего бинарника (decomp-all), stats, декомп с параметрами/полями** |
