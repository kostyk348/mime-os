...
| **Клеточный реверс** | `rev <binary> <dir>`, `rev type/wave/cluster/graph/types/hash/diff/branch/recon/vftables` | objdump → .eml-граф, волна типов, кластеры, diff, ветки, разведка, **vftable-детект** |
