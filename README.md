...
| **Клеточный реверс** | `rev <binary> <dir>`, `rev type/wave/cluster/graph/types/hash/diff/branch/recon` | objdump → .eml-граф (libc: 2354 ф-ции за 0.5s), волна типов, кластеры, diff, ветки, разведка (строки/энтропия) |
