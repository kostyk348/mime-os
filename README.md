...
| **Клеточный реверс** | `rev <binary> <dir>`, `rev decomp --struct/strings/dot/...` | .eml-граф, **структурный декомпилятор (if/else/while, локальные, типы из волны)**, строки, DOT, ветки, vftables |
